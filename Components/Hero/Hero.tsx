    ...
    <div className="w-full">
      <div className="relative mx-auto max-w-[2500px]">
        <div className="relative mx-5 flex h-[1100px] font-medium text-slate-800 md:mx-10 lg:mx-16 xl:mx-24">
          {/* Z-0 */}
          <div className="absolute right-[5%] top-[8%] z-0 hidden w-96 lg:flex xl:text-lg">
          ...
          {/* Z-1 */}
          <div className="absolute -left-10 right-0 top-[18%] z-[1] mx-auto flex aspect-square h-[500px] w-[500px] items-center justify-center rounded-full bg-gradient-to-b from-orange-500/70 xs:left-0 lg:left-auto lg:-right-24 lg:h-[800px] lg:w-[800px]"></div>
          <div className="absolute right-0 left-0 top-[22%] z-[5] mx-auto flex w-40 flex-col items-start gap-y-12 py-10 text-stone-100 md:left-auto md:right-52 md:w-auto lg:text-slate-600 xl:text-slate-800">
          ...
          {/* Z-3 */}
          <div className="relative top-[0%] z-[3] mx-auto w-[550px] text-center text-[28px] font-extrabold xs:text-[32px] sm:text-[46px] md:absolute md:top-[5%] md:text-start 2xl:top-[5%] 2xl:w-[850px] 2xl:text-[72px]">
            Your first and{" "}
          ...
          {/* Z-4 */}
          <div className="absolute top-[35%] right-0 left-0 z-[4]">
            <Image
              src={Background2}
              alt={""}
              width={2000}
            ...
            ></Image>
            {/* <div className="absolute -bottom-20 h-72 w-full -scale-x-125 scale-y-150 bg-gradient-to-t from-gray-100"></div> */}
            <div className="absolute -bottom-60 right-0 left-0 z-[6] mx-auto">
              ...
              {/* fog */}
              {/* <div className="absolute -left-0 top-0 z-[7] my-6 h-[90%] w-40 bg-gradient-to-r from-white"></div>
              <div className="absolute -right-0 top-0 z-[7] my-6 h-[90%] w-40 bg-gradient-to-l from-white"></div> */}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute top-[700px] mx-auto w-full lg:h-[300px] xl:h-[400px] 2xl:top-[900px]">
        <div className="sticky top-10 z-[5]">
          <SearchBar />
        </div>
      </div>
    </div>
