    ...
    <div className="w-full">
      <div className="mx-auto max-w-[2500px]">
        <div className="my-6 mx-5 flex flex-col md:mx-10 lg:mx-16 xl:mx-24">
          <div className="text-center text-xl font-semibold text-orange-500 xs:text-2xl sm:text-start">
            About us
          </div>
          <div className="flex flex-col gap-y-16 lg:flex-row lg:gap-x-16 xl:gap-x-24">
            ...
            <div className="mt-10 flex w-full flex-col items-center justify-start gap-y-10 sm:items-start lg:w-1/2">
              <h1 className="text-center text-4xl font-extrabold xs:text-[50px] xs:leading-[60px] sm:text-start sm:text-[60px] sm:leading-[70px] md:text-[70px] md:leading-[90px]">
                We&prime;re here to
                <br /> help you find your dream home.
              </h1>

              <div className="text-center font-medium sm:pr-16 sm:text-start">
            ...
            <div className="relative flex h-[650px] w-full flex-row gap-x-6 lg:w-1/2 4xl:h-[900px]">
              ...
              <div className="flex w-1/2 flex-col items-end justify-center gap-y-6 xs:w-7/12">
                <div className="relative h-4/6 w-full overflow-hidden rounded-3xl shadow-gray-500/40 transition-all duration-500 ease-in hover:shadow-lg xs:w-8/12">
                  <Image
                    src={image2}
                    alt={""}
                    fill
                ...
                <div className="relative h-2/6 w-full overflow-hidden rounded-3xl shadow-gray-500/40 transition-all duration-500 ease-in hover:shadow-lg">
                  <Image
                    src={image1}
                    alt={""}
                    fill
              ...
              <div className="flex w-1/2 items-center xs:w-5/12">
                <div className="relative mt-20 h-4/6 w-full overflow-hidden rounded-3xl shadow-gray-500/40 transition-all duration-500 ease-in hover:shadow-lg xs:mx-2">
                  <Image
                    src={image3}
                    alt={""}
                    fill
              ...
              <div className="absolute right-0 bottom-10 flex h-20 w-[280px] select-none flex-row items-center justify-start gap-x-4 rounded-3xl bg-white px-5 shadow-lg shadow-gray-600/20 transition-all duration-500 hover:scale-105 hover:shadow-lg hover:shadow-gray-600/20 xs:right-10 xs:h-24 xs:w-[330px]">
